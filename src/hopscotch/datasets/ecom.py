"""
Synthetic e-commerce clickstream dataset for hopscotch demos.

Six months of user sessions on a consumer-electronics store. Five embedded
stories make the data useful for teaching Hopscotch's analysis tools:
